...
Lines со стадиями команды и итоговым кодом. Результат `command_succeeded`
подтверждает успешное выполнение команды, но сам по себе не доказывает отсутствие
эффекта на удалённом хосте.
